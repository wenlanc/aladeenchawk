...
await $`awk '{gsub(/NEXT_PUBLIC_REST_API_ENDPOINT="http:\\/\\/localhost"/,"NEXT_PUBLIC_REST_API_ENDPOINT=\\"https://${domainName}/backend\\""); print $0}' ./admin/rest/.env.template > ./admin/rest/.env`
